 ...
 * Last generated by Orchestration Designer at: 2026년 7월 27일 (월) 오후 5시 21분 49초
 */
public class UnregisteredGuide extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("its2", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("ivr2", "1.0"));


		// build events for the field: "UnregisteredGuide"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("UnregisteredGuide", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("RegisterCallback");
		return submit;
	}
	/**
