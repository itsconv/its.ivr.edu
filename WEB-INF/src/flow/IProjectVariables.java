 ...
 * Last generated by Orchestration Designer at: 2026년 7월 24일 (금) 오후 3시 44분 17초
 */
public interface IProjectVariables {
	...
	public static final String UNREGISTERED_GUIDE = "UnregisteredGuide";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String REGISTERED_GUIDE = "RegisteredGuide";
	...
	public static final String UNREGISTERED_GUIDE_FIELD_CONFIDENCE = "confidence";
	public static final String UNREGISTERED_GUIDE_FIELD_INPUTMODE = "inputmode";
	public static final String UNREGISTERED_GUIDE_FIELD_INTERPRETATION = "interpretation";
	public static final String UNREGISTERED_GUIDE_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String UNREGISTERED_GUIDE_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String UNREGISTERED_GUIDE_FIELD_UTTERANCE = "utterance";
	public static final String UNREGISTERED_GUIDE_FIELD_VALUE = "value";
	...
	public static final String REGISTERED_GUIDE_FIELD_COLUMN_0 = "Column0";
	public static final String REGISTERED_GUIDE_FIELD_CONFIDENCE = "confidence";
	public static final String REGISTERED_GUIDE_FIELD_INPUTMODE = "inputmode";
	public static final String REGISTERED_GUIDE_FIELD_INTERPRETATION = "interpretation";
	public static final String REGISTERED_GUIDE_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String REGISTERED_GUIDE_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String REGISTERED_GUIDE_FIELD_UTTERANCE = "utterance";
	public static final String REGISTERED_GUIDE_FIELD_VALUE = "value";
	...
	public static final String CALL_FIELD_API_SUCCESS = "apiSuccess";
	public static final String CALL_FIELD_CALLBACK_ID = "callbackId";
	public static final String CALL_FIELD_CALLBACK_NUMBER = "callbackNumber";
	public static final String CALL_FIELD_CUST_NAME = "custName";
	public static final String CALL_FIELD_CUSTOMER_FOUND = "customerFound";
	public static final String CALL_FIELD_DB_SUCCESS = "dbSuccess";
	public static final String CALL_FIELD_LOOKUP_PHONE = "lookupPhone";
	public static final String CALL_FIELD_RETRY_COUNT = "retryCount";
	public static final String CHECK_INPUT_FIELD_CONFIDENCE = "confidence";
	public static final String CHECK_INPUT_FIELD_INPUTMODE = "inputmode";
	public static final String CHECK_INPUT_FIELD_INTERPRETATION = "interpretation";
	public static final String CHECK_INPUT_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CHECK_INPUT_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CHECK_INPUT_FIELD_UTTERANCE = "utterance";
	public static final String CHECK_INPUT_FIELD_VALUE = "value";
