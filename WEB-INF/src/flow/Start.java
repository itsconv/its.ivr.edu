...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("closedGreeting");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_CONFIDENCE,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_INPUTMODE,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_INTERPRETATION,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_NOINPUTCOUNT,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_NOMATCHCOUNT,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_UTTERANCE,
			IProjectVariables.UNREGISTERED_GUIDE_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UNREGISTERED_GUIDE, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.REGISTERED_GUIDE_FIELD_COLUMN_0,
			IProjectVariables.REGISTERED_GUIDE_FIELD_CONFIDENCE,
			IProjectVariables.REGISTERED_GUIDE_FIELD_INPUTMODE,
			IProjectVariables.REGISTERED_GUIDE_FIELD_INTERPRETATION,
			IProjectVariables.REGISTERED_GUIDE_FIELD_NOINPUTCOUNT,
			IProjectVariables.REGISTERED_GUIDE_FIELD_NOMATCHCOUNT,
			IProjectVariables.REGISTERED_GUIDE_FIELD_UTTERANCE,
			IProjectVariables.REGISTERED_GUIDE_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.REGISTERED_GUIDE, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			...
			IProjectVariables.CALL_FIELD_RETRY_COUNT };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CALL, variableFields, new String[] {"", "", "", "", "", "", "", "3"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CHECK_INPUT_FIELD_CONFIDENCE,
			IProjectVariables.CHECK_INPUT_FIELD_INPUTMODE,
			IProjectVariables.CHECK_INPUT_FIELD_INTERPRETATION,
			IProjectVariables.CHECK_INPUT_FIELD_NOINPUTCOUNT,
			IProjectVariables.CHECK_INPUT_FIELD_NOMATCHCOUNT,
			IProjectVariables.CHECK_INPUT_FIELD_UTTERANCE,
			IProjectVariables.CHECK_INPUT_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CHECK_INPUT, variableFields, null, session, false, false );
		session.putVariable(variable);
