 ...
 * Last generated by Orchestration Designer at: 2026년 7월 30일 (목) 오전 10시 11분 59초
 */
public class RegistSuccess extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("its5", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CallEndLog");
		return submit;
	}
	/**
