 ...
 * Last generated by Orchestration Designer at: 2026년 7월 27일 (월) 오전 9시 51분 53초
 */
public class closedGreeting extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("its1", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("LookupCustomer");
		return submit;
	}
	/**
